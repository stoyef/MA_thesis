...
read_in_sim_data <- function(simfit){ # simfit is a string: 00,01 etc
  sim_stats = read.table(paste("/Users/stoye/sciebo/Studium/31-M-Thesis Master's Thesis/simulation_results_updated/full_sim_",simfit,"/sim_stats.csv",sep=""),
                    row.names = 1,sep=",")
  estimated_gamma_mu = read.table(paste("/Users/stoye/sciebo/Studium/31-M-Thesis Master's Thesis/simulation_results_updated/full_sim_",simfit,"/estimated_gamma_mu.csv",sep=""),
                                  row.names=1, sep=",")
  estimated_gamma_sigma = read.table(paste("/Users/stoye/sciebo/Studium/31-M-Thesis Master's Thesis/simulation_results_updated/full_sim_",simfit,"/estimated_gamma_sigma.csv",sep=""),
                                     row.names=1, sep=",")
  estimated_vm_mu = read.table(paste("/Users/stoye/sciebo/Studium/31-M-Thesis Master's Thesis/simulation_results_updated/full_sim_",simfit,"/estimated_vm_mu.csv",sep=""),
                               row.names=1, sep=",")
  estimated_vm_kappa = read.table(paste("/Users/stoye/sciebo/Studium/31-M-Thesis Master's Thesis/simulation_results_updated/full_sim_",simfit,"/estimated_vm_kappa.csv",sep=""),
                                  row.names=1, sep=",")
  estimated_autocor_gamma = read.table(paste("/Users/stoye/sciebo/Studium/31-M-Thesis Master's Thesis/simulation_results_updated/full_sim_",simfit,"/estimated_autocor_gamma.csv",sep=""),
                                       row.names=1, sep=",")
  estimated_autocor_vm = read.table(paste("/Users/stoye/sciebo/Studium/31-M-Thesis Master's Thesis/simulation_results_updated/full_sim_",simfit,"/estimated_autocor_vm.csv",sep=""),
                                    row.names=1, sep=",")
  decoding_accuracies = read.table(paste("/Users/stoye/sciebo/Studium/31-M-Thesis Master's Thesis/simulation_results_updated/full_sim_",simfit,"/decoding_accuracies.csv",sep=""),
                    row.names=1, sep=",")
...
boxplot(c(sim_res_00$decoding_accuracies, sim_res_01$decoding_accuracies,
        ...
        bty="n",
        ylim=c(0.8,1),xaxt='n',xlab='fitted model',
        pch=19)
axis(1, at=c(1,2,3,4), labels=c("","","",""))
mtext(c("AR(0,0)","AR(1,1)","AR(2,2)","AR(3,3)"),side=1,at=c(1,2,3,4),line=1,cex=1)
