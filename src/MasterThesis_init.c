...
/* .Call calls */
extern SEXP _MasterThesis_allprobs_cpp(SEXP, SEXP, SEXP, SEXP, SEXP);
...
extern SEXP _MasterThesis_forward_cpp(SEXP, SEXP, SEXP, SEXP, SEXP, SEXP, SEXP);

static const R_CallMethodDef CallEntries[] = {
  {"_MasterThesis_allprobs_cpp",    (DL_FUNC) &_MasterThesis_allprobs_cpp,    5},
  ...
  {"_MasterThesis_forward_cpp",     (DL_FUNC) &_MasterThesis_forward_cpp,     7},
  {NULL, NULL, 0}
};
