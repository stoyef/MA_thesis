### 2022-09-29
### simulation variant using step lengths with closer means (ceteris paribus)
# mu = (25,30)
...
write.table(comps,
            "/Users/stoye/sciebo/Studium/31-M-Thesis Master's Thesis/simulation_results_25_30/computation_times.csv",
            col.names=FALSE, sep=",")


mod=full_sim_33
# find rows where state 1 and 2 are swapped and swap back
swap = which(mod$estimated_parameters$estimated_1_param_1[,1] > 27.5 & mod$estimated_parameters$estimated_1_param_1[,1] < 35 & mod$estimated_parameters$estimated_1_param_1[,2] > 20 & mod$estimated_parameters$estimated_1_param_1[,2] < 27.5)
for (row in swap){
...
not_global = which(mod$estimated_parameters$estimated_2_param_1[,2] < -0.5 | mod$estimated_parameters$estimated_1_param_1[,2] < 27.5)
not_global
...
write.table(data.frame(c(length(not_global),250-length(not_global)),
            ...
            "/Users/stoye/sciebo/Studium/31-M-Thesis Master's Thesis/simulation_results_25_30/full_sim_33/sim_stats.csv",
            col.names=FALSE, sep=",")
write.table(mod$estimated_parameters$estimated_1_param_1, 
            "/Users/stoye/sciebo/Studium/31-M-Thesis Master's Thesis/simulation_results_25_30/full_sim_33/estimated_gamma_mu.csv",
            col.names=FALSE, sep=",")
write.table(mod$estimated_parameters$estimated_1_param_2, 
            "/Users/stoye/sciebo/Studium/31-M-Thesis Master's Thesis/simulation_results_25_30/full_sim_33/estimated_gamma_sigma.csv",
            col.names=FALSE, sep=",")
write.table(mod$estimated_parameters$estimated_2_param_1, 
            "/Users/stoye/sciebo/Studium/31-M-Thesis Master's Thesis/simulation_results_25_30/full_sim_33/estimated_vm_mu.csv",
            col.names=FALSE, sep=",")
write.table(mod$estimated_parameters$estimated_2_param_2, 
            "/Users/stoye/sciebo/Studium/31-M-Thesis Master's Thesis/simulation_results_25_30/full_sim_33/estimated_vm_kappa.csv",
            col.names=FALSE, sep=",")
write.table(mod$estimated_autocorrelation$estimated_1_autocor, 
            "/Users/stoye/sciebo/Studium/31-M-Thesis Master's Thesis/simulation_results_25_30/full_sim_33/estimated_autocor_gamma.csv",
            col.names=FALSE, sep=",")
write.table(mod$estimated_autocorrelation$estimated_2_autocor, 
            "/Users/stoye/sciebo/Studium/31-M-Thesis Master's Thesis/simulation_results_25_30/full_sim_33/estimated_autocor_vm.csv",
            col.names=FALSE, sep=",")
write.table(mod$decoding_accuracies, 
            "/Users/stoye/sciebo/Studium/31-M-Thesis Master's Thesis/simulation_results_25_30/full_sim_33/decoding_accuracies.csv",
            col.names=FALSE, sep=",")
